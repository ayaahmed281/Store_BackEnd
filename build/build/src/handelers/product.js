...
router.get("/products/:id", (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post("/products", helpers_1.authToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const Product = {
...
router.put("/products/:id", helpers_1.authToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const Product = {
...
router.delete("/products/:pid", helpers_1.authToken, (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
